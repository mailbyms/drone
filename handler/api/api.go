...
import (
	...
	"github.com/mailbyms/drone/handler/api/acl"
	"github.com/mailbyms/drone/handler/api/auth"
	"github.com/mailbyms/drone/handler/api/badge"
	globalbuilds "github.com/mailbyms/drone/handler/api/builds"
	"github.com/mailbyms/drone/handler/api/ccmenu"
	"github.com/mailbyms/drone/handler/api/events"
	"github.com/mailbyms/drone/handler/api/queue"
	"github.com/mailbyms/drone/handler/api/repos"
	"github.com/mailbyms/drone/handler/api/repos/builds"
	"github.com/mailbyms/drone/handler/api/repos/builds/branches"
	"github.com/mailbyms/drone/handler/api/repos/builds/deploys"
	"github.com/mailbyms/drone/handler/api/repos/builds/logs"
	"github.com/mailbyms/drone/handler/api/repos/builds/pulls"
	"github.com/mailbyms/drone/handler/api/repos/builds/stages"
	"github.com/mailbyms/drone/handler/api/repos/collabs"
	"github.com/mailbyms/drone/handler/api/repos/crons"
	"github.com/mailbyms/drone/handler/api/repos/encrypt"
	"github.com/mailbyms/drone/handler/api/repos/secrets"
	"github.com/mailbyms/drone/handler/api/repos/sign"
	globalsecrets "github.com/mailbyms/drone/handler/api/secrets"
	"github.com/mailbyms/drone/handler/api/system"
	"github.com/mailbyms/drone/handler/api/user"
	"github.com/mailbyms/drone/handler/api/user/remote"
	"github.com/mailbyms/drone/handler/api/users"
