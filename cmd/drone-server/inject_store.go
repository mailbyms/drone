...
import (
	...
	"github.com/mailbyms/drone/metric"
	"github.com/mailbyms/drone/store/batch"
	"github.com/mailbyms/drone/store/batch2"
	"github.com/mailbyms/drone/store/build"
	"github.com/mailbyms/drone/store/cron"
	"github.com/mailbyms/drone/store/logs"
	"github.com/mailbyms/drone/store/perm"
	"github.com/mailbyms/drone/store/repos"
	"github.com/mailbyms/drone/store/secret"
	"github.com/mailbyms/drone/store/secret/global"
	"github.com/mailbyms/drone/store/shared/db"
	"github.com/mailbyms/drone/store/shared/encrypt"
	"github.com/mailbyms/drone/store/stage"
	"github.com/mailbyms/drone/store/step"
	"github.com/mailbyms/drone/store/user"
